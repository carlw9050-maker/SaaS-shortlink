...
public class UserController {
     ...
     * 查询用户名是否可用
     */
    @GetMapping("/api/shortlink/admin/v1/user/available-username")
     ...
     * 用户更新
     */
    @PutMapping("/api/shortlink/admin/v1/update-user")
     ...
     * 检查用户是否登陆
     */
    @GetMapping("/api/shortlink/admin/v1/user-checkLogin")
