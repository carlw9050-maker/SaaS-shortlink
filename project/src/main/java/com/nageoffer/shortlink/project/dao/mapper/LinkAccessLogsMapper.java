...
public interface LinkAccessLogsMapper extends BaseMapper<LinkAccessLogsDO> {
    ...
    @Select("SELECT " +
            ...
            "    count DESC " +
            "LIMIT 5;")
    List<HashMap<String, Object>> listTopIpByShortLink(@Param("param") ShortLinkStatisticReqDTO requestParam);
    //调用方法时会自动执行上面的sql查询语句
    ...
    @Select("SELECT " +
            ...
            "    count DESC " +
            "LIMIT 5;")
    List<HashMap<String, Object>> listTopIpByGroup(@Param("param") ShortLinkGroupStatisticReqDTO requestParam);

    /**
     * 根据单个短链接获取指定日期内新旧访客数据
     */
    @Select("SELECT " +
